      ...
      <section className="registraion">
        <div className="registration__container">
          ...
          <form onSubmit={handleSubmit}
                className={`registration__form ${login ? 'registration__form_hiden' : 'registration__form_showed'}`}>
          ...
          <h3
            className={`registration__description ${login ? 'registration__description_showed' : 'registration__description_hiden'}`}>You've
            already registred and logined. You don't need this.</h3>
        </div>
      </section>
